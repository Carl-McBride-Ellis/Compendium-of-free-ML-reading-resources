...
10. [Deep learning / neural networks](#deep-learning--neural-networks) (17)
...
* :earth_africa: ["Deep Learning with Python, Third Edition"](https://deeplearningwithpython.io/chapters/) by François Chollet, and Matthew Watson 
...
* :orange_book: ["Speech and Language Processing: An Introduction to Natural Language Processing, Computational Linguistics, and Speech Recognition"](https://web.stanford.edu/~jurafsky/slp3/ed3book_jan26.pdf) by Dan Jurafsky and James H. Martin 
...
* :earth_africa: ["Causal Inference: The Remix"](https://mixtape.scunning.com/) by Scott Cunningham
